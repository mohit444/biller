                        ...
                        <div class="col-md-12 ">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo $this->Form->input('ordtitle', array('class'=>'form-control','id'=>'forinputs')); ?>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                            ...
                            <div class="col-md-1">
                                <div class="form-group">
                                    ...
                                    <?php echo $this->Form->submit('Delete',array('class'=> 'btn btn-danger','id'=>'forinputs')); ?>                            
                                </div>
                            </div> 
                        </div>
                    </div>
